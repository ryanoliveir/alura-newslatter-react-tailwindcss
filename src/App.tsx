    ...
    <main className="flex px-6 drop-shadow font-inter ">
      ...
      <section className="flex flex-col gap-6 bg-white p-10 rounded-lg lg:w-1/2 justify-center lg:rounded-l-none">
        <div className="self-center relative group">
          <svg
            className="fill-blue-dark absolute top-0 left-1 opacity-0 group-hover:opacity-100 group-hover:animate-ping"
            width="35"
            height="20"
            viewBox="0 0 44 20"
            fill="none"
          ...
          <svg
            className="w-12 h-12 fill-blue-light stroke-blue-dark group-hover:animate-sino"
            viewBox="0 0 24 24"
            xmlns="http://www.w3.org/2000/svg"
          >
            <path
      ...
      <div className="text-center">
        ...
        <p className="text-xl mb-2 text-gray-700">Mergulhe em uma plataforma que respira tecnologia!</p>
      </div>

      <form>
        <label className="text-sm font-bold text-gray-700 " htmlFor="email">Email</label>
        <input className="text-sm mb-4 w-full pl-3 rounded border py-2 shadow focus:outline-none hover:border-blue-light hover:ring-1 hover:ring-blue-dark focus:border-blue-dark focus:ring-1 focus:ring-blue-dark" id="email" type="email" placeholder="Digite seu endereço de email"/>                    
        <button className="font-bold text-white bg-blue-dark w-full py-2 rounded-full shadow-2xl hover:bg-blue-hover duration-150" type="button">Inscreva-se</button>
      </form>
    </section>
    </main>
  );
